        ...
        <div class="row">
          <div class="col"> 
            ...
            <div class="card-body" >
                ...
                <a class='btn btn-primary'href="<?php echo site_url(); ?>PenguranganStockProduksiClient/postproduksi/<?= $id_detailproduksi ?>" data-toggle="modal" data-target="#exampleModal">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?php echo site_url(); ?>PenguranganStockProduksiClient/postproduksi/<?= $id_detailproduksi ?>" method="post">
              ...
              <table id="tabel" class="table table-bordered">
                ...
                foreach ($penguranganstockproduksi as $rows) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url(); ?>PenguranganStockProduksiClient/putproduksi/<?php echo $rows->id_penguranganstockproduksi; ?>" class="btn btn-warning">
                            <i class="fa fa-pen" aria-hidden="true"></i></a>
                            <a href="<?= base_url(); ?>PenguranganStockProduksiClient/deleteproduksi/<?= $rows->id_detailproduksi; ?>/<?= $rows->id_penguranganstockproduksi; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
